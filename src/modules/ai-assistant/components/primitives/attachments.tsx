...
function AttachmentPreviewIcon({ Icon, size }: { Icon: typeof ImageIcon; size: string }) {
  return <Icon className={cn(size, 'text-muted-foreground')} />
}
...
function AttachmentPreviewContent({
  ...
  return fallbackIcon ?? <AttachmentPreviewIcon Icon={Icon} size={iconSize} />
}
