...
export const SpeechInput = ({
  ...
  // Use navigator language by default if not provided
  const activeLang = lang ?? (typeof window !== 'undefined' ? navigator.language : 'es-ES')
  ...
  return (
    <div className="relative inline-flex items-center justify-center">
      ...
      <Button
        ...
        variant={isListening ? 'default' : props.variant}
        disabled={isDisabled}
