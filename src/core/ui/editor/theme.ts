// @ts-ignore - LexKiT types might be complex to resolve in this environment
import { type LexKiTThemePalette } from '@lexkit/editor'
 ...
 */
export const shadcnTheme: LexKiTThemePalette = {
