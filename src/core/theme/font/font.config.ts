...
export type TFontGroup = (typeof FONT_GROUPS)[number]

export const DEFAULT_FONT_GROUP: TFontGroup = 'modern'
...
export const FONT_GROUP_CONFIG: Record<TFontGroup, IFontGroupConfig> = {
  modern: {
    label: 'Moderno',
